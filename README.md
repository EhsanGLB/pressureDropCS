# pressureDropCS
This is a code stream for pressure drop written based on foam-extend-4.1.


## Mathematical Relationships
$$ {\Delta p }= {\left({1 \over A} {\int p \ dA} \right)}_{outlet-inlet}  $$

Which $\Delta p$, $p$, and $dA$ are pressure difference, pressure, and area element, respectively.


## Installation
It is working on foam-extend-4.1
```bash
git clone https://github.com/EhsanGLB/pressureDropCS.git
```
